...
public class UpdateEmployeeInDtoTest{
    /**
     * To test the userDto class.
     */
    @Test
    public void UpdateEmployeeInDtoTest() {
    ...
    public void testToString() {
        ...
        String dateOfJoining = "dateOfJoining";
        String role = "role";
        UserInDto userInDto = buildUserDto(userId, employeeId,firstName,lastName,email,dateOfBirth,phoneNo,dateOfExit,desiganation,dateOfJoining,role);
...
//        assertEquals(,userDto.toString());
    ...
    public void testEqualsAndHashCode() {
        ...
        String role = "role";
        UserInDto userInDto = buildUserDto(userId, employeeId,firstName,lastName,email,dateOfBirth,phoneNo,dateOfExit,desiganation,dateOfJoining,role);
        UserInDto userDto1 = buildUserDto(userId, employeeId,firstName,lastName,email,dateOfBirth,phoneNo,dateOfExit,desiganation,dateOfJoining,role);
    ...
    public UserInDto buildUserDto(int userId,String employeeId,String firstName,String lastName,String email,String dateOfBirth,String phoneNo,String dateOfExit,String desiganation,String dateOfJoining,String role) {
        UserInDto userInDto = new UserInDto();
