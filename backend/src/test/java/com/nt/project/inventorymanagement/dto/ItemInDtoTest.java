...
class ItemInDtoTest {
    ...
    public void testToString() {
        ...
        ItemInDto itemDto = buildItemDto(itemId,assetName,assetNo,assetType,dateOfPurchase,warrantyPeriod,assetLocation,assignStatus,workingStatus ,incidents ,employeeId);
...
//        assertEquals(,userDto.toString());
    ...
    public void testEqualsAndHashCode() {
        ...
        ItemInDto itemDto1 = buildItemDto(itemId,assetName,assetNo,assetType,dateOfPurchase,warrantyPeriod,assetLocation,assignStatus,workingStatus ,incidents ,employeeId);
        ItemInDto itemDto2 = buildItemDto(itemId,assetName,assetNo,assetType,dateOfPurchase,warrantyPeriod,assetLocation,assignStatus,workingStatus ,incidents ,employeeId);
    ...
    public ItemInDto buildItemDto(int itemId,String assetName,String assetNo,String assetType,String dateOfPurchase,String warrantyPeriod,String assetLocation,boolean assignStatus,String workingStatus,String incidents, String employeeId) {
