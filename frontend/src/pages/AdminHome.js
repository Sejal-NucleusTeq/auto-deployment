...
//   const urls = [
//     "http://localhost:8080/inventory/employees",
...
//                 <td>{emp.phoneNo}</td>
//                 <td>
//                 <button style={{color:"white",backgroundColor:"black"}} onClick={()=>UpdateEmp(emp)}>
//                     UPDATE
//                   </button>
//                 </td>
...
//                 <td>{item.assign_status ? "Assigned" : "Unassigned"}</td>
//                <td>{item.incidents==null?"NULL":item.incidents}</td>
//                 <td>
//                 <button style={{color:"white",backgroundColor:"black"}} onClick={()=>UpdateItem(item)}>
//                     UPDATE
//                   </button>
//                 </td>
